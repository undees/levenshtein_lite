...
RSpec.describe LevenshteinLite do
  ...
  context ".distance" do
    ...
    it { should measure_the_distance_between(
    ...
    it "returns zero for strings that are the same object" do
      s = "it's cold in here!".freeze
      expect(subject.distance(s, s)).to eq(0)
    end
    ...
    it "considers composed / decomposed Unicode codepoints as different" do
      ...
      expect(subject.distance(
               ...
               single_char_accented_e)).to eq(2)
    end
  end
end
